...
function LoginForm() {
  ...
  const isFromJobApply = callbackUrl.includes("/jobs");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(
        isFromJobApply
          ? "Signed in! Redirecting to complete your job application..."
    ...
    <div className="relative z-10 w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-slate-400">
          {isFromJobApply
            ? "Sign in to apply for this job and track your application"
            : "Sign in to access your HireLoop account"}
        </p>

        {isFromJobApply && (
          <div className="mt-3 inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-500/15 border border-purple-500/30 text-purple-300 text-xs font-medium">
            <span>🔒</span> Login required to submit your job application
          </div>
        )}
      </div>
      ...
      <div className="rounded-3xl bg-[#141217]/85 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 shadow-2xl shadow-black/80">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-[#141217] px-3 text-slate-500">Don&apos;t have an account?</span>
          </div>
        </div>
...
export default function LoginPage() {
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 py-28 bg-[#070709] overflow-hidden">
      ...
      <div className="absolute bottom-10 left-1/4 w-80 h-80 bg-[#5B60F6]/10 blur-[130px] rounded-full pointer-events-none" />
